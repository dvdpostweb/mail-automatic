...
// Build the list of image extensions
      ...
      if ($this->tep_not_null($html_images)) {
...
//    function build_message($params = array()) {
    function build_message($params = '') {
      ...
      if ($this->tep_not_null($this->html_images)) {
      ...
      $null = NULL;
      $attachments = (($this->tep_not_null($this->attachments)) ? true : false);
      $html_images = (($this->tep_not_null($this->html_images)) ? true : false);
      $html = (($this->tep_not_null($this->html)) ? true : false);
      $text = (($this->tep_not_null($this->text)) ? true : false);
...
//          $message =& $this->add_mixed_part();
        ...
        case (($html == true) && ($attachments == false) && ($html_images == false)):
          if ($this->tep_not_null($this->html_text)) {
/* HPDL PHP3 */
